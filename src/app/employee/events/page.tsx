...
const AlertCard: React.FC<{ alert: Alert }> = ({ alert }) => {
  return (
    <div className=" rounded-lg w-full shadow-md border border-gray-200 p-6 mb-4 hover:shadow-lg transition-shadow duration-200">
      <div className="flex items-start wifull gap-4 bg-white">
        ...
        <div className="flex">
          <p className="font-semibold text-md text-gray-800 mb-3">{alert.message} </p>
    ...
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Stay updated with your personalized notifications</p>
        </div>

        <div className="space-y-0 grid grid-cols-3  gap-3">
          {userAlerts.length === 0 ? (
            <div className="bg-white rounded-lg shadow-md border border-gray-200 p-8 text-center">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">No alerts for you</h3>
