    ...
    <div className='flex flex-col gap-5'>
      ...
      <div className='grid grid-cols-3 gap-5'>
        <div className='bg-white px-5 h-18 flex items-center border border-[#ddd] rounded gap-5'>
          ...
          <div>
            ...
            <h4 className='font-semibold'>{stats.ongoing}</h4>
          </div>
        </div>
        ...
        <div className='bg-white px-5 h-18 flex items-center border border-[#ddd] rounded gap-5'>
          ...
          <div>
            ...
            <h4 className='font-semibold'>{stats.completed}</h4>
          </div>
        </div>
      ...
      <div className='flex flex-col gap-4'>
        {projects.map((project) => (
          <Link href={`/manager/project/${project._id}`} key={project._id} className={`p-3 px-5 border rounded-md flex flex-col gap-3 ${project.isActive === false ? 'bg-red-50 border-red-200' : 'bg-white border-[#ddd]'}`}>
